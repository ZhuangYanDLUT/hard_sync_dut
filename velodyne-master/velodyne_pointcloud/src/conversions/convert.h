...
namespace velodyne_pointcloud
{
  ...
  private:
	...
	//========== 后加入的，与synin同步 ==============
	ros::Subscriber lidar_syn_;
	void processLidarSynin(const gnss_driver::lidar_sync_msg::ConstPtr &_syncMsg);
	double timeImuSys;
	double timeImu;
	double timeGpsUTC;
	double lastValidTimeGpsUTC;
	double lastValidTimeIMU;
	bool isValidGnssHasCome;
	int hour_circle;
	double lidar_internal_time;
	double last_lidar_internal_time;
	double imu_imusys;
	//=======================================
